  ...
  return (
    <section className="navbar p-6 animate__animated animate__fadeInDown ">
      <div className="flex flex-1 justify-between">
        ...
        >
          <img src={logo} alt="HS" className="w-12" srcSet="" />
        </a>
        ...
        <div className="menuContent">
          ...
          >
            <button
              ...
              title="menu"
              id="hambtn"
              className={`relative text-3xl cursor-pointer mx-2 md:hidden block ${hambState === "close" ? "" : "z-20 "}`}
              onClick={(e) => handleMenu(e)}
            >
              <CgMenuRight
                className={`w-9 h-9  stroke-1 ${hambState === "close" ? "stroke-defslate" : "hidden"}`}
              />
              <IoClose
                className={` w-9 h-9  stroke-1 ${hambState === "close" ? "hidden " : "fill-emerald-600/70 animate__animated animate__rotateIn animate__faster"}`}
              />
            </button>
