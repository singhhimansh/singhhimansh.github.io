  ...
  return (
    <div id="home" className="Home relative">
        ...
        <div className="flex flex-1 justify-between">
          ...
          >
            <img
              src={logo}
              alt="HS"
              className={`w-12 ${hambState === "close" ? "" : " "}`}
              srcSet=""
            />
          </a>
          ...
          <div className="menuContent">
            ...
            <div
              id="menuForPC"
              className={`hidden mr-7 font-calibre  text-lightslate md:flex gap-3 justify-center items-center ${
                hambState === "close" ? "" : ""
              } `}
            >
              <a
              ...
              >
                <button className="p-2 hover:text-emerald-300 moveup">
                  <span className="text-emerald-300">h. </span>home( )
                </button>
              </a>
              ...
              >
                <button className="mx-2 text-center hover:text-emerald-300 moveup  duration-300 px-4 pb-1 pt-2 hover:bg-emerald-100/5 rounded border border-emerald-300/90">
                  <span className="text-emerald-300 ">h. </span> resume( )
                </button>
              </a>
            </div>
            ...
            >
              <button
                ...
                title="menu"
                id="hambtn"
                className={`relative text-3xl cursor-pointer mx-2 md:hidden block ${
                  hambState === "close" ? "" : "z-20 "
                }`}
                onClick={(e) => handleMenu(e)}
              >
                <CgMenuRight
                  className={`w-9 h-9  stroke-1 ${
                    hambState === "close" ? "stroke-defslate" : "hidden"
                  }`}
                />
                <IoClose
                  className={` w-9 h-9  stroke-1 ${
                    hambState === "close"
                      ? "hidden "
                      : "fill-emerald-600/70 animate__animated animate__rotateIn animate__faster"
                  }`}
                />
              </button>
              ...
              <div
                id="menuForMob"
                className={`h-screen md:hidden fixed z-10  font-calibre text-lightslate  bg-navyshadow border-l border-l-lightestnavy/80 flex flex-col justify-center items-center  gap-10   ${
                  hambState === "close"
              ...
              >
                ...
                >
                  <button
                    onClick={() => setHambState("close")}
                    className="p-2 hover:text-emerald-300 moveup"
                  >
                    <span className="text-emerald-300">h. </span>home( )
                  </button>
                </a>
                ...
                >
                  <button
                    onClick={() => setHambState("close")}
                    className="mx-2 text-center hover:text-emerald-300 moveup  duration-300 px-4 py-2  hover:bg-emerald-100/5 rounded border border-emerald-300/90"
                  >
                    <span className="text-emerald-300 ">h. </span> resume( )
                  </button>
                </a>
      ...
      <main className="flex justify-center border-0 border-cyan-400 ">
        <div
          className={`w-11/12 md:w-8/12 md:px-2 border-0 border-purple-600  flex flex-col ${
            hambState === "close" ? "z-0" : "-z-10 blur-md scroll"
          } `}
        >
          {/* introduction */}
          <Intro />
                ...
                return (
                  ...
                  >
                    <img
                      ...
                      title={skill}
                      src={require(`./data/img/skills/${skill}.png`)}
                      alt=""
                    />
                  </Tilt>
                );
          ...
          >
            ...
            <div className="flex flex-col gap-5 w-96 text-nowrap">
              <div className="flex gap-4 grow w-full">
                <a href="mailto:s.himanshusingh56@gmail.com" className="w-full">
                  <button className="pt-2  pb-1 px-4  text-slate-400 text-center border border-emerald-400/90 rounded-md hover:bg-emerald-100/5 hover:text-lightestslate w-full">
                    <HiOutlineMailOpen className="inline-block pb-1" /> Drop a
                    mail
                  </button>
                </a>
                <a href="tel:+919084618246" className="w-full">
                  <button className="pt-2 pb-1 px-4  text-slate-400 text-center border border-emerald-400/90 rounded-md hover:bg-emerald-100/5 hover:text-lightestslate w-full">
              ...
              >
                <button className="pt-2 grow pb-1 px-4  text-slate-400 text-center border border-emerald-400/90 rounded-md hover:bg-emerald-100/5 hover:text-lightestslate w-full">
                  <SiWhatsapp className="inline-block pb-1" /> Let's talk on
                  WhatsApp
                </button>
              </a>
            </div>
          ...
          <section
            id="copyright"
            className="copyright m-10 mb-5 flex justify-center text-slate-400"
          >
